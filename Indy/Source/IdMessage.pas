...
begin
  ...
  try
    ...
    begin
      ...
      {(Edgar 14/12/2012) servidor UOL (empresas, não contas pessoais) está bloqueando nossos e-mails. Acreditamos que
      possa ser por isso:
      http://www.indyproject.org/KB/index.html?xlibraryheaderspam.htm
      http://www.delphigroups.info/3/7/138198.html}
